...
export function Question10DishwashingFrequency({ 
  onNext, 
  onBack, 
  onExit, 
  initialValue = 0, 
  ...
  return ( 
    <WaterQuestionLayout 
      ...
      currentQuestionIndex={3} // Ajusta según el orden real de la sub-pregunta 
      totalQuestionsInCategory={3} 
      icon="/public/img/traste-calendario.webp" 
      onBack={onBack} 
      onExit={onExit} 
      onNext={() => onNext({ dishwashingTimesPerDay: timesPerDay })} 
    ...
    > 
      <div className="flex flex-col items-center w-full max-w-md mx-auto"> 
        ...
        <h2 className="text-xl sm:text-2xl font-extrabold text-gray-900 leading-snug mb-1 text-center font-quicksand"> 
          ¿Cuántas veces al día lavas los platos? 
        </h2> 
        ...
        <div className="w-full bg-[#DCEFEF] border border-[#BDE0E0] rounded-xl p-3 flex items-center gap-2 text-left"> 
          ...
          <p className="text-[11px] sm:text-xs text-[#2178BD] font-medium leading-tight font-quicksand"> 
            <span className="font-bold">Referencia:</span> Lavar platos a mano puede usar hasta 20 litros por lavado; con lavavajillas, el consumo baja considerablemente. 
          </p> 
        </div> 
      </div> 
    </WaterQuestionLayout> 
