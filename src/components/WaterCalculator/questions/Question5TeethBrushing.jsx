...
export function Question5TeethBrushing({
  onNext,
  onBack,
  onExit,
  initialValue = 0,
  ...
  return (
    <WaterQuestionLayout
      ...
      icon="/img/toothbrush.webp"
      onBack={onBack}
      onExit={onExit}
      onNext={() => onNext({ teethBrushingFrequencyPerDay: timesPerDay })}
      ...
      <div className="flex flex-col items-center w-full max-w-md mx-auto">
        ...
        <div className="w-full bg-[#DCEFEF] border border-[#BDE0E0] rounded-xl p-3 flex items-center gap-2 text-left">
          ...
          <p className="text-[11px] sm:text-xs text-[#2178BD] font-medium leading-tight font-quicksand">
            <span className="font-bold">Referencia:</span> Lo común para una persona es cepillarse entre 2 y 3 veces al día.
          </p>
        </div>
      </div>
    </WaterQuestionLayout>
