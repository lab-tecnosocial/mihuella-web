...
export function Question8ClothesWashing({
  onNext,
  onBack,
  onExit,
  initialValue = 0,
  ...
  return (
    <WaterQuestionLayout
      ...
      icon="/img/lavar-ropa.webp"
      onBack={onBack}
      onExit={onExit}
      onNext={() => onNext({ clothesWashingFrequencyPerWeek: timesPerWeek })}
    ...
    >
      <div className="flex flex-col items-center w-full max-w-md mx-auto">
        <h2 className="text-xl sm:text-2xl font-extrabold text-gray-900 leading-snug mb-1 text-center font-quicksand">
          ¿Cuántas veces lavas ropa en una semana?
        </h2>
        ...
        <div className="w-full bg-[#DCEFEF] border border-[#BDE0E0] rounded-xl p-3 flex items-center gap-2 text-left">
          ...
          <p className="text-[11px] sm:text-xs text-[#2178BD] font-medium leading-tight font-quicksand">
            <span className="font-bold">Referencia:</span> Lo común es lavar la ropa entre 1 y 3 veces por semana.
          </p>
        </div>
      </div>
    </WaterQuestionLayout>
