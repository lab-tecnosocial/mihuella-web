...
export function Question3ShowerDuration({
  onNext,
  onBack,
  onExit,
  initialValue = 0,
  ...
  return (
    <WaterQuestionLayout
      ...
      onBack={onBack}
      onExit={onExit}
      onNext={() => onNext({ showerMinutes: minutes })}
    ...
    >
      <div className="flex flex-col items-center w-full max-w-md mx-auto">
        ...
        <h2 className="text-xl sm:text-2xl font-extrabold text-gray-900 leading-snug mb-1 text-center font-quicksand">
          ¿Aproximadamente cuántos minutos duran tus duchas?
        </h2>
        ...
        <div className="w-full bg-[#DCEFEF] border border-[#BDE0E0] rounded-xl p-3 flex items-center gap-2 text-left">
          ...
          <p className="text-[11px] sm:text-xs text-[#2178BD] font-medium leading-tight font-quicksand">
            <span className="font-bold">Referencia:</span> Una ducha promedio dura entre 5 a 10 minutos.
          </p>
        </div>
      </div>
    </WaterQuestionLayout>
